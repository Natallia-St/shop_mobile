...
# Эти модели будут использоваться для фильтрации (чекбокса)
...
class CategoryFeature(models.Model):
    ...
    feature_name = models.CharField(verbose_name='Имя характеристики для категории', max_length=50, unique=False)
    ...
    class Meta:
        # Поля должны быть уникальными при рассмотрении вместе.
...
class FeatureValidator(models.Model):
    ...
    def __str__(self):
        return f"Категория {self.category.name} | " \
               f"Характристика {self.feature_key}  | " \
